...
const peopleInfo = {
  ...
  education: [
    "博士", "硕士", "本科", "大专", "中专", "职高", "技校", "高中", "初中", "小学", "其他"
  ],
  political: [
    '中共党员', '群众', '共青团员', '其他'
  ],
  blood: ['A型', 'B型', 'AB型', 'O型', '其他'],
  marriage: ['未婚', '已婚', '离异', '丧偶', '其他'],
  faith: ['无宗教信仰', '佛教', '喇嘛教', '道教', '天主教', '基督教', '东正教', '伊斯兰教', '其他'],
  military: ['未服兵役', '退出现役', '士兵预备役', '军官预备役', '服现役', '其他'],
  houseType: ['租赁房屋', '居民家中', '单位内部', '工地现场', '旅店', '自购房', '其他'],
  liveType: ['单身居住', '家庭居住', '合伙居住', '集团居住', '其他'],
  relationShip: ['父母', '配偶', '子女', '祖父母或外祖父母', '兄弟姐妹', '其他'],
  work: ['国家机关工作人员', '事业单位工作人员', '企业职工', '学生', '个体', '其他'],
  register: ['是', '否'],
  use: ['务工', '务农', '治病疗养', '借读培训', '服务', '出差', '经商', '保姆', '投亲靠友', '探亲访友', '旅游', '其他'],
  police: [
    "集宁区-虎山派出所",
...
module.exports = {
  ...
  householdNum:peopleInfo.householdNum,
  ...
  houseType: peopleInfo.houseType,
  liveType: peopleInfo.liveType,
  relationShip: peopleInfo.relationShip,
  work: peopleInfo.work,
  register: peopleInfo.register,
  use: peopleInfo.use,
  police: peopleInfo.police
}